...
utils.seekbars = (function() {
   ...
   * Slider constructor
   */
  var Slider = function(slider,callback) {
    ...
    var callback = this.callback = (typeof callback == 'function')? callback : false; 
  ...
  return {
     ...
     */
    bind: function bind(elem, callback) {
      elem = typeof elem === 'object' ? elem : document.querySelector(elem);
      sliders.push(new Slider(elem,callback));
    },
